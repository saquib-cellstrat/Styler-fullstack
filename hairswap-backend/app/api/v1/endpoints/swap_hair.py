...
async def swap_hair(
    ...
    alignment_impl: str | None = Form(default=None),
    extraction_impl: str | None = Form(default=None),
    warp_impl: str | None = Form(default=None),
    harmonization_impl: str | None = Form(default=None),
    blending_impl: str | None = Form(default=None),
    ...
    overrides = {
        "alignment": alignment_impl or "",
        "extraction": extraction_impl or "",
        "warp": warp_impl or "",
        "harmonization": harmonization_impl or "",
        "blending": blending_impl or "",
    }
    try:
        result = pipeline.run(context=context, implementation_overrides=overrides)
